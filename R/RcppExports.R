...
getTIMSPeakLists <- function(file, frameIDsList, mobilityStarts, mobilityEnds, precursorMZs, method, mzWindow, minAbundance = 1L, topMost = 0L, minIntensityPre = 0L, minIntensityPost = 0L, minIntensityFinal = 0L, scanStartsListN = NULL, scanEndsListN = NULL) {
    .Call(`_patRoon_getTIMSPeakLists`, file, frameIDsList, mobilityStarts, mobilityEnds, precursorMZs, method, mzWindow, minAbundance, topMost, minIntensityPre, minIntensityPost, minIntensityFinal, scanStartsListN, scanEndsListN)
}
