...
getEICList <- function(backend, startMZs, endMZs, startTimes, endTimes, startMobs, endMobs, gapFactor, mzExpIMSWindow, minIntensityIMS, mode = "simple", sumMS = FALSE, sumEIMs = 1L, smoothWindow = 3L, smoothExt = 0L, saveEIMs = FALSE, pad = FALSE, minEICIntensity = 0L, minEICAdjTime = 0L, minEICAdjPoints = 0L, minEICAdjIntensity = 0L, topMost = 0L) {
    .Call(`_patRoon_getEICList`, backend, startMZs, endMZs, startTimes, endTimes, startMobs, endMobs, gapFactor, mzExpIMSWindow, minIntensityIMS, mode, sumMS, sumEIMs, smoothWindow, smoothExt, saveEIMs, pad, minEICIntensity, minEICAdjTime, minEICAdjPoints, minEICAdjIntensity, topMost)
}
...
getIMSIsolationInfo <- function(backend) {
    .Call(`_patRoon_getIMSIsolationInfo`, backend)
}
...
findFeatTableDups <- function(rts, mzs, mobs, ints, tolRT, tolMZ, tolMob, mzCentered, mobCentered, prefIntensityRatio) {
    .Call(`_patRoon_findFeatTableDups`, rts, mzs, mobs, ints, tolRT, tolMZ, tolMob, mzCentered, mobCentered, prefIntensityRatio)
}
