...
getGroupIDs <- function(featRTs, featMZs, featMobs, ints, anaIDs, rtWindow, mzWindow, mobWindow, verbose) {
    .Call(`_patRoon_getGroupIDs`, featRTs, featMZs, featMobs, ints, anaIDs, rtWindow, mzWindow, mobWindow, verbose)
}
