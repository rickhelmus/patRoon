...
getMSPeakLists <- function(backend, startTimes, endTimes, precursorMZs, fixedIsolationWidth, withPrecursor, retainPrecursor, MSLevel, method, mzWindow, startMobs, endMobs, relMinAbundance, absMinAbundance, minRelCumIntensity, smoothWindowIMS, halfWindowIMS, maxGapIMS, topMost, minIntensityIMS, minIntensityPre, minIntensityPost, minBPIntensity) {
    .Call(`_patRoon_getMSPeakLists`, backend, startTimes, endTimes, precursorMZs, fixedIsolationWidth, withPrecursor, retainPrecursor, MSLevel, method, mzWindow, startMobs, endMobs, relMinAbundance, absMinAbundance, minRelCumIntensity, smoothWindowIMS, halfWindowIMS, maxGapIMS, topMost, minIntensityIMS, minIntensityPre, minIntensityPost, minBPIntensity)
}
...
findFeatTableDups <- function(rts, rtMins, rtMaxs, mzs, mobs, ints, tolRT, tolMZ, tolMob, minPeakOverlap) {
    .Call(`_patRoon_findFeatTableDups`, rts, rtMins, rtMaxs, mzs, mobs, ints, tolRT, tolMZ, tolMob, minPeakOverlap)
}
