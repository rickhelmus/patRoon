...
#' @slot featureGraphs A \code{list} with feature network graphs (\CRAN{igraph}) for each analysis.
...
#'   is selected using the following priority: (1) groups containing a \superscript{13}C isotope, (2) the largest group,
...
#'   collapsed to one row per feature, the "best" grouping is selected in case of conflicts (see the \verb{nontarget
