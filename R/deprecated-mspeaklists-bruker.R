...
#'
#' Uses Bruker DataAnalysis to read the data needed to generate MS peak lists. This function is now deprecated, please
#' use \code{\link{generateMSPeakLists}} instead.
#'
...
#' MS peak lists. This function is now deprecated, please use \code{\link{generateMSPeakLists}} instead.
#'
...
#'   only works when features were obtained with the \code{\link{findFeaturesBruker}} function. Since all MS spectra are
