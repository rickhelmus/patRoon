...
#'
#'   Calculation of formulae with DataAnalysis always occurs with the 'feature approach' (see \verb{Candidate assignment} in \code{\link{generateFormulas}}).
#'
