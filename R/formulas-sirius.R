                                                              ...
                                                              dryRun = FALSE)
{
    ...
    formTable <- doSIRIUS(fGroups, MSPeakLists, calculateFeatures, profile, adduct, relMzDev, elements,
                          ...
                          projectPath, token, extraOptsGeneral, extraOptsFormula, mobSpecSims, mobSpecSimsAna, verbose,
                          "formulasSIRIUS", patRoon:::processSIRIUSFormulas, NULL, splitBatches, dryRun)
