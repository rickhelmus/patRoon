                                                       ...
                                                       logPath = NULL)
{
    ...
    hash <- makeHash(obj, absMzDev, normalizeScores, makeFileHash(IDFile))
    cd <- loadCacheData("estimateIDConfidenceFormulas", hash)
    if (!is.null(cd))
        return(cd)
    ...
    saveCacheData("estimateIDConfidenceFormulas", obj, hash)
