...
setGeneric("normalizeIntensities", function(fGroups, featNorm, normFunc = max, standards = NULL, ISTDRTWindow = 120,
                                            ISTDMZWindow = 300, minISTDs = 3, ...) standardGeneric("normalizeIntensities"))
