...
setGeneric("removeGroups", function(fGroups, indices, updateFeatures = TRUE) standardGeneric("removeGroups"))
setGeneric("cleanGroups", function(fGroups, cleanUnassignedFeatures) standardGeneric("cleanGroups"))
setGeneric("removeEmptyAnalyses", function(fGroups) standardGeneric("removeEmptyAnalyses"))
setGeneric("updateFeatures", function(fGroups, checkUnassigned) standardGeneric("updateFeatures"))
...
#' @template generics
setGeneric("calculatePeakQualities", function(obj, weights = NULL, flatnessFactor = 0.05, ...) standardGeneric("calculatePeakQualities"))
