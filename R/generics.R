...
setGeneric("mergeIons", function(fGroups, components, ...) standardGeneric("mergeIons"))
...
setGeneric("unset", function(obj, sets = NULL) standardGeneric("unset"))
...
#' @template generics
setGeneric("makeSet", function(..., adducts) standardGeneric("makeSet", signature = "..."))
