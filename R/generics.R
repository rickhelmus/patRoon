...
setGeneric("findFeaturesPSAFD", function(obj, ...) standardGeneric("findFeaturesPSAFD"))
...
setGeneric("groupFeaturesP", function(obj, param, ...) standardGeneric("groupFeaturesP"))

#' @rdname groupFeaturesOpenMS
setGeneric("groupFeaturesOpenMS", function(feat, ...) standardGeneric("groupFeaturesOpenMS"))

#' @rdname groupFeaturesOpenMS
setGeneric("groupFeaturesPOpenMS", function(obj, ...) standardGeneric("groupFeaturesPOpenMS"))
...
#' @rdname generateCompoundsLibrary
setGeneric("generateCompoundsPLibrary", function(obj, ...) standardGeneric("generateCompoundsPLibrary"))
...
#' @templateVar func hasIMS
#' @templateVar desc returns \code{TRUE} if the object has ion mobility values
#' @template generics
setGeneric("hasIMS", function(obj) standardGeneric("hasIMS"))
...
#' @name pred-quant
setGeneric("predictRespFactorsP", function(obj, ...) standardGeneric("predictRespFactorsP"))
