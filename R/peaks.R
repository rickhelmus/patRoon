...
findPeaksOpenMS <- function(EICs, fillEICs, params, logPath)
{
    ...
    settings <- c("-in" = chromFile,
                  ...
                  "-algorithm:PeakPickerChromatogram:sgolay_frame_length" = params$SGolayFrameLength,
                  "-algorithm:PeakPickerChromatogram:sgolay_polynomial_order" = params$SGolayPolyOrder,
                  "-algorithm:PeakPickerChromatogram:use_gauss" = boolToChr(params$useGauss),
                  "-algorithm:PeakPickerChromatogram:gauss_width" = params$gaussWidth,
                  "-algorithm:PeakPickerChromatogram:signal_to_noise" = params$SN,
                  "-algorithm:PeakPickerChromatogram:sn_win_len" = params$SNWinLen,
                  "-algorithm:PeakPickerChromatogram:sn_bin_count" = params$SNBinCount,
                  "-algorithm:PeakPickerChromatogram:method" = params$method,
