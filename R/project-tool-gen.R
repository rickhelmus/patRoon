...
genScriptAnnBlock <- function(ionization, IMS, settingsAnn, adductArg, doSusps, addMFDB, generator)
{
    ...
    if (doForms)
    {
        ...
        generator$addCall("formulas", "generateFormulas", list(
            ...
            adductArg,
            list(name = "elements", value = "CHNOP", quote = TRUE, condition = settingsAnn$formulasAlgo == "GenForm"),
            list(name = "oc", value = FALSE, condition = settingsAnn$formulasAlgo == "GenForm"),
            list(name = "config", value = "getSIRIUSConfig()", condition = settingsAnn$formulasAlgo == "SIRIUS"),
    ...
    if (doComps)
    {
        ...
        generator$addCall("compounds", "generateCompounds", list(
            ...
            list(name = "config", value = "getSIRIUSConfig()", condition = settingsAnn$compoundsAlgo == "SIRIUS"),
