...
if (!is.null(rmdVars$components))
{
    componButtons <- sapply(seq_along(allGroups), function(gi)
    {
        ...
        maybeAddButton(gi, componentFGroups, "components", "showComponentSpec", cmpNames[1], gi)
    })
} else
...
DT::datatable(fGroupsSpecDT, options = list(paging = FALSE, scrollY = "200px", autoWidth = TRUE,
