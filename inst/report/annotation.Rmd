...
isSusp <- inherits(rmdVars$fGroups, "featureGroupsScreening")
...
if (isSusp)
{
    ...
    if (!is.null(fGroupsSpecDT[["annotatedMSMSSimilarity"]]))
        fGroupsSpecDT[, annotatedMSMSSimilarity := round(annotatedMSMSSimilarity, 2)]
} else
...
fGroupsSpecDT <- fGroupsSpecDT[, intersect(c("group", "ret", "mz", "suspect", "d_rt", "d_mz",
                                             "suspFormRank", "suspCompRank",
                                             "annotatedMSMSSimilarity", "estIDLevel",
                                             "fragMZMatches", "fragFormMatches", "fragFormCompMatches"),
                                           names(fGroupsSpecDT)),
                               with = FALSE]
