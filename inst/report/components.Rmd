...
for (ci in seq_len(cCount))
{
    ...
    makeCachedPlot(allPlots[curPlotInd], "plotSpec",
    ...
    makeCachedPlot(allPlots[curPlotInd], "plotEIC",
...
if (rmdVars$optimizePng && curPlotInd > 0)
    optimizePngPlots(allPlots, rmdVars$maxProcAmount)
```
...
sppaths <- file.path(plotPathLink, sprintf("component_spec_%d.png", compSeq))
eicpaths <- file.path(plotPathLink, sprintf("component_eic_%d.png", compSeq))
...
if (isHClust)
{
    intnpaths <- file.path(plotPathLink, sprintf("component_int_norm_%d.png", compSeq))
    intapaths <- file.path(plotPathLink, sprintf("component_int_abs_%d.png", compSeq))
