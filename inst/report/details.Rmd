                ...
                bslib::card_body(
                    ...
                    htmltools::withTags({
                        div(class = "pb-1",
                            ...
                            input(type = "checkbox", id = "features-cols-qual", onChange = 'showFGCols("qualities", this.checked)'),
                            label("for" = "features-cols-qual", "Quality scores"),
                            input(type = "checkbox", id = "features-filter", onChange = 'toggleFGFilters(this.checked)',
                                  checked = TRUE),
