    ...
    callIncl(bslib::layout_column_wrap,
        ...
        maybeIncl(utils$hasSuspects(), bslib::navs_tab_card(
            ...
            bslib::nav(
                "Suspect",
                bslib::card_body(
                    style = "display: flex; flex-wrap: nowrap; justify-content: flex-start; height: 100%; padding-top: 10px; align-items: flex-start; gap: 15px;",
                    utils$genSuspInfoTable(),
                    htmltools::img(id = "struct_view-suspect", style = "min-width: 20%; max-height: 65%;"),
                )
            ),
        )),
        ...
        callIncl(bslib::navs_tab_card,
            ...
            maybeIncl(utils$hasTPs(), bslib::nav(
                "Parent similarity",
                bslib::card_body(
                    style = "display: flex; flex-wrap: wrap; justify-content: flex-start; max-height: 100%; padding-top: 25px; align-items: flex-start; gap: 40px;",
                    utils$genTPSimTable(),
