        ...
        bslib::layout_column_wrap(
            ...
            callIncl(bslib::layout_column_wrap,
                     ...
                     bslib::card(
                         ...
                         bsCardBodyNoFill(
                             utils$makeToolbar("detailsTabPlain", columnToggles = list(
                                 list(value = "group", name = "Group info", checked = TRUE),
                                 list(value = "intensities", name = "Intensities", checked = TRUE),
                                 maybeIncl(utils$hasConcs(), list(value = "concentrations", name = "Concentrations",
                                                                  checked = TRUE)),
                                 maybeIncl(utils$hasFQualities(), list(value = "qualities", name = "Quality scores")),
                                 maybeIncl(utils$settings$features$chromatograms$large,
                     ...
                     maybeIncl(utils$hasComponentsTPs(), bslib::card(
                         ...
                         bsCardBodyNoFill(
                             utils$makeToolbar("TPCandidatesTab", groupBy = list(
            ...
            callIncl(bslib::layout_column_wrap,
                     ...
                     callIncl(bslib::navs_tab_card,
                              ...
                              bslib::nav(
                                  "Features",
                                  bsCardBodyNoFill(
                                      utils$makeToolbar("featuresTab", groupBy = list(
                                          list(value = "", name = "None"),
                                          list(value = "rGroup", name = "Replicate group"),
                                          maybeIncl(utils$hasSets(), list(value = "set", name = "Set"))
                                      ), columnToggles = maybeIncl(utils$hasFQualities(), list(
                              ...
                              maybeIncl(utils$hasConcs(), bslib::nav(
                                  "Concentrations",
                                  bsCardBodyNoFill(utils$makeToolbar("concsTab")),
                                  bslib::card_body_fill(utils$genConcsTable())
                              )),
                              maybeIncl(utils$hasTox(), bslib::nav(
                                  "Toxicities",
                                  bsCardBodyNoFill(utils$makeToolbar("toxTab")),
                              ...
                              maybeIncl(utils$hasFormulas(), bslib::nav(
                                  ...
                                  bsCardBodyNoFill(
                                      bsCardBodyNoFill(
                                          utils$makeToolbar("formulasTab", tagsPreButtons = htmltools::tagList(
                              ...
                              maybeIncl(utils$hasCompounds(), bslib::nav(
                                  "Compounds",
                                  bsCardBodyNoFill(
                                      utils$makeToolbar("compoundsTab", groupBy = list(
                                          list(value = "", name = "None"),
