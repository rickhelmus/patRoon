...
mdprintf("Generating report components: ")
...
bslib::layout_column_wrap(
        ...
        bslib::card_body(
            ...
            htmltools::withTags({
                callIncl(div, class = "pb-1",
                    ...
                    maybeIncl(settings$chromatograms$large, input(type = "checkbox", id = "fg-large-chroms",
                                                                  onChange = 'showFGCols("chrom_large", this.checked)')),
                    maybeIncl(settings$chromatograms$large, label("for" = "fg-large-chroms", "Large chromatograms")),
    ...
    callIncl(bslib::layout_column_wrap,
        ...
        maybeIncl(utils$hasComponentsTPs(), callIncl(bslib::navs_tab_card,
            title = "Selected parent",
            full_screen = TRUE,
            maybeIncl(settings$chromatograms$large, bslib::nav(
                "Chromatogram",
                bslib::card_body_fill(htmltools::img(id = "chrom_view-tp"))
            )),
            maybeIncl(utils$hasComponentsFromTPs(), bslib::nav(
                "Suspects",
                bslib::card_body(class = "mx-auto", htmltools::strong("Parent")),
                bslib::card_body(
                    class = "propTabAndImg",
                    utils$genSuspInfoTable("parentInfoTab"),
                    htmltools::img(id = "struct_view-parent", style = "min-width: 20%;")
                ),
                bslib::card_body(class = "mx-auto", htmltools::strong("Transformation product")),
                bslib::card_body(
                    class = "propTabAndImg",
            ...
            maybeIncl(utils$hasTPGraphs(), bslib::nav(
                "Transformations",
        ...
        callIncl(bslib::navs_tab_card,
            ...
            maybeIncl(utils$hasMSPL(), bslib::nav(
                ...
                bslib::card_body(
                    ...
                    htmltools::img(id = "spectrumMS", style = "min-width: 20%;"),
                    htmltools::img(id = "spectrumMSMS", style = "min-width: 20%;"),
                ...
                bslib::card_body(
                    ...
                    htmltools::withTags({
                        div(class = "pb-1",
                            ...
                            button(type = "button", class = "btn btn-primary btn-sm ms-2", onClick = "Reactable.downloadDataCSV('compoundsTab')", "Download CSV"),
