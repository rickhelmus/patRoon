...
makeRTab <- function(d, id, visible, ...)
{
    rt <- reactable::reactable(d, elementId = id, pagination = FALSE, wrap = FALSE, resizable = TRUE,
...
makeRTab(tables$features$plain, "detailsTabPlain", TRUE)
makeRTab(tables$features$plain, "detailsTabComponents", FALSE)
makeRTab(tables$features$plain, "detailsTabSuspects", FALSE)
makeRTab(tables$features$plain, "detailsTabTPs", FALSE)
```
