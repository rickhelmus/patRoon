...
```{r results='asis',eval=utils$hasComponentsFromTPs()}
...
downCSVButton <- function(tab, file, quoteTab = TRUE)
{
    if (quoteTab)
        tab <- paste0("'", tab, "'")
    htmltools::tags$button(type = "button", class = "btn btn-secondary btn-sm",
                           onClick = sprintf("downloadCSV(%s, '%s')", tab, file),
                           bsicons::bs_icon("filetype-csv", size = "1.5em", title = "Download CSV"))
}

toggleExpandButton <- function(id, tab, quoteTab = TRUE, visible = TRUE)
{
    if (quoteTab)
        tab <- paste0("'", tab, "'")
    htmltools::tags$button(type = "button", class = "btn btn-secondary btn-sm", id = id,
                           style = paste("display:", if (visible) "" else "none"),
                           onClick = sprintf("Reactable.toggleAllRowsExpanded(%s)", tab),
        ...
        div(class = "pb-1",
            ...
            div(class = "btn-group btn-group-sm mx-1", role = "group", "aria-label" = "TP_parent group",
                ...
                input(type = "radio", class = "btn-check", name = "tpparbtn", id = "viewTPDetailsParents",
                      autocomplete = "off", onChange = 'updateView("TPs")'),
                ...
                input(type = "radio", class = "btn-check", name = "tpparbtn", id = "viewTPDetailsTPs",
                      autocomplete = "off", onChange = 'updateView("TPs")', checked = TRUE),
                ...
                htmltools::withTags({
                    div(
                        ...
                        select(name = "TPCompon", id = "TPCompon-select", onChange = "updateTPCompon(this.value)",
                               style = "min-width: 0;",
                               Map(utils$getTPComponIDs(), utils$getTPComponNames(), f = function(v, n) option(value = v, n))),
            ...
            callIncl(bslib::layout_column_wrap,
                     ...
                     bslib::card(
                         ...
                         bsCardBodyNoFill(
                             ...
                             htmltools::withTags({
                                 callIncl(div, class = "pb-1 ps-1",
                                          ...
                                          downCSVButton("getSelFGTableElement()", "featureGroups.csv", quoteTab = FALSE),
                                          toggleExpandButton("fg-expand", "getSelFGTableElement()", quoteTab = FALSE)
                                 )
                             })
                         ),
                         callIncl(bslib::card_body_fill,
                                  ...
                                  maybeIncl(utils$hasComponentsTPs(), utils$genFGTableTPsParents()),
                     ...
                     maybeIncl(utils$hasComponentsTPs(), bslib::card(
                         ...
                         bsCardBodyNoFill(
                             ...
                             htmltools::withTags({
                                 div(class = "pb-1 ps-1",
                                     label("for" = "TPCand-groupBy", "Group by"),
                                     select(id = "TPCand-groupBy", onChange = "setTabGroupBy('TPCandidatesTab', this.value, 'tpcand-expand')",
                                            style = list("margin-right" = "10px", "margin-top" = "3px"),
                                            option(value = "", "None"),
                                            option(value = "formula", "Formula"),
                                            option(value = "formulaDiff", "\U0394 Formula")
                                     ),

                                     input(type = "checkbox", id = "fg-filter", onChange = 'toggleFGFilters(this.checked)'),
                                     label("for" = "fg-filter", style = list("margin-right" = "10px"), "Filters"),
                                     
                                     downCSVButton("TPCandidatesTab", "TPCandidates.csv"),
                                     toggleExpandButton("tpcand-expand", "TPCandidatesTab", visible = FALSE)
                                 )
                             })
                         ),
                                  ...
                                  bsCardBodyNoFill(
                                      ...
                                      htmltools::withTags({
                                          callIncl(div, class = "pb-1 ps-1",
                                                   ...
                                                   callIncl(select, id = "features-groupBy", onChange = "setTabGroupBy('featuresTab', this.value, 'feat-expand')",
                                                            style = list("margin-right" = "10px", "margin-top" = "3px"),
                                                            option(value = "", "None"),
                                                   ...
                                                   downCSVButton("featuresTab", "features.csv"),
                                                   toggleExpandButton("feat-expand", "featuresTab", visible = FALSE)
                                          )
                                      })
                                  ),
                                  ...
                                  bsCardBodyNoFill(
                                      ...
                                      htmltools::withTags({
                                          div(class = "pb-1 ps-1",
                                              ...
                                              downCSVButton("concsTab", "concentrations.csv")
                                          )
                                      })
                                  ),
                                  ...
                                  bsCardBodyNoFill(
                                      ...
                                      htmltools::withTags({
                                          div(class = "pb-1 ps-1",
                                              ...
                                              downCSVButton("toxTab", "toxicities.csv")
                                          )
                                      })
                                  ),
                                  ...
                                  bsCardBodyNoFill(
                                      ...
                                      htmltools::withTags({
                                          div(class = "pb-1 ps-1",
                                              ...
                                              downCSVButton("formulasTab", "formulas.csv"),
                                              toggleExpandButton("form-expand", "formulasTab")
                                          )
                                      })
                                  ),
                                  ...
                                  bsCardBodyNoFill(
                                      ...
                                      htmltools::withTags({
                                          div(class = "pb-1 ps-1",
                                              ...
                                              select(id = "compounds-groupBy", onChange = "setTabGroupBy('compoundsTab', this.value)",
                                                     style = list("margin-right" = "10px", "margin-top" = " 3px"),
                                                     option(value = "", "None"),
                                              ...
                                              downCSVButton("compoundsTab", "compounds.csv"),
                                              toggleExpandButton("comp-expand", "compoundsTab"),
