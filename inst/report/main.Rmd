...
doPlotChord <- length(rmdVars$fGroups) > 0 && "chord" %in% rmdVars$reportPlots && rGroupLenNonEmpty > 1
doPlotVenn <- length(rmdVars$fGroups) > 0 && "venn" %in% rmdVars$reportPlots && rGroupLenNonEmpty > 1 && rGroupLen < 6
doPlotUpSet <- length(rmdVars$fGroups) > 0 && "upset" %in% rmdVars$reportPlots && rGroupLenNonEmpty > 1
