...
if (length(compFGroups))
    fGroupsSpecDT[group %in% compFGroups, compound := showButton("showSpec", match(group, allGroups), "comp")]
if (length(formFGroups))
    fGroupsSpecDT[group %in% formFGroups, formula := showButton("showSpec", match(group, allGroups), "form")]
