...
// getEICList
Rcpp::List getEICList(const MSReadBackend& backend, const std::vector<SpectrumRawTypes::Mass>& startMZs, const std::vector<SpectrumRawTypes::Mass>& endMZs, const std::vector<SpectrumRawTypes::Time>& startTimes, const std::vector<SpectrumRawTypes::Time>& endTimes, const std::vector<SpectrumRawTypes::Mobility>& startMobs, const std::vector<SpectrumRawTypes::Mobility>& endMobs, SpectrumRawTypes::Time gapFactor, SpectrumRawTypes::Intensity minIntensityIMS, const std::string& mode, SpectrumRawTypes::Time sumWindowMZ, SpectrumRawTypes::Time sumWindowMob, unsigned smoothWindowMZ, unsigned smoothWindowMob, SpectrumRawTypes::Mass smoothExtMZ, SpectrumRawTypes::Mobility smoothExtMob, bool saveMZProfiles, bool saveEIMs, bool pad, SpectrumRawTypes::Intensity minEICIntensity, SpectrumRawTypes::Time minEICAdjTime, unsigned minEICAdjPoints, SpectrumRawTypes::Intensity minEICAdjIntensity, unsigned topMost);
RcppExport SEXP _patRoon_getEICList(SEXP backendSEXP, SEXP startMZsSEXP, SEXP endMZsSEXP, SEXP startTimesSEXP, SEXP endTimesSEXP, SEXP startMobsSEXP, SEXP endMobsSEXP, SEXP gapFactorSEXP, SEXP minIntensityIMSSEXP, SEXP modeSEXP, SEXP sumWindowMZSEXP, SEXP sumWindowMobSEXP, SEXP smoothWindowMZSEXP, SEXP smoothWindowMobSEXP, SEXP smoothExtMZSEXP, SEXP smoothExtMobSEXP, SEXP saveMZProfilesSEXP, SEXP saveEIMsSEXP, SEXP padSEXP, SEXP minEICIntensitySEXP, SEXP minEICAdjTimeSEXP, SEXP minEICAdjPointsSEXP, SEXP minEICAdjIntensitySEXP, SEXP topMostSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< SpectrumRawTypes::Time >::type sumWindowMZ(sumWindowMZSEXP);
    Rcpp::traits::input_parameter< SpectrumRawTypes::Time >::type sumWindowMob(sumWindowMobSEXP);
    Rcpp::traits::input_parameter< unsigned >::type smoothWindowMZ(smoothWindowMZSEXP);
    Rcpp::traits::input_parameter< unsigned >::type smoothWindowMob(smoothWindowMobSEXP);
    Rcpp::traits::input_parameter< SpectrumRawTypes::Mass >::type smoothExtMZ(smoothExtMZSEXP);
    Rcpp::traits::input_parameter< SpectrumRawTypes::Mobility >::type smoothExtMob(smoothExtMobSEXP);
    Rcpp::traits::input_parameter< bool >::type saveMZProfiles(saveMZProfilesSEXP);
...
RcppExport SEXP _patRoon_getStats(SEXP backendSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSReadBackend& >::type backend(backendSEXP);
    rcpp_result_gen = Rcpp::wrap(getStats(backend));
    return rcpp_result_gen;
END_RCPP
}
// getMSSpectrum
...
// getCentroidedFrame
Rcpp::DataFrame getCentroidedFrame(const MSReadBackend& backend, int index, SpectrumRawTypes::Mobility mobStart, SpectrumRawTypes::Mobility mobEnd, unsigned smoothWindow, unsigned halfWindow, SpectrumRawTypes::Mass maxGap);
RcppExport SEXP _patRoon_getCentroidedFrame(SEXP backendSEXP, SEXP indexSEXP, SEXP mobStartSEXP, SEXP mobEndSEXP, SEXP smoothWindowSEXP, SEXP halfWindowSEXP, SEXP maxGapSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSReadBackend& >::type backend(backendSEXP);
    ...
    Rcpp::traits::input_parameter< SpectrumRawTypes::Mass >::type maxGap(maxGapSEXP);
    rcpp_result_gen = Rcpp::wrap(getCentroidedFrame(backend, index, mobStart, mobEnd, smoothWindow, halfWindow, maxGap));
    return rcpp_result_gen;
END_RCPP
}
// getScans
...
// getMSPeakLists
Rcpp::List getMSPeakLists(const MSReadBackend& backend, const std::vector<SpectrumRawTypes::Time>& startTimes, const std::vector<SpectrumRawTypes::Time>& endTimes, const std::vector<SpectrumRawTypes::Mass>& precursorMZs, SpectrumRawTypes::Mass fixedIsolationWidth, bool withPrecursor, bool retainPrecursor, int MSLevel, const std::string& method, SpectrumRawTypes::Mass mzWindow, const std::vector<SpectrumRawTypes::Mobility> startMobs, const std::vector<SpectrumRawTypes::Mobility> endMobs, SpectrumRawTypes::PeakAbundance relMinAbundance, SpectrumRawTypes::PeakAbundance absMinAbundance, float minRelCumIntensity, unsigned smoothWindowIMS, unsigned halfWindowIMS, SpectrumRawTypes::Mass maxGapIMS, unsigned topMost, SpectrumRawTypes::Intensity minIntensityIMS, SpectrumRawTypes::Intensity minIntensityPre, SpectrumRawTypes::Intensity minIntensityPost, SpectrumRawTypes::Intensity minBPIntensity);
RcppExport SEXP _patRoon_getMSPeakLists(SEXP backendSEXP, SEXP startTimesSEXP, SEXP endTimesSEXP, SEXP precursorMZsSEXP, SEXP fixedIsolationWidthSEXP, SEXP withPrecursorSEXP, SEXP retainPrecursorSEXP, SEXP MSLevelSEXP, SEXP methodSEXP, SEXP mzWindowSEXP, SEXP startMobsSEXP, SEXP endMobsSEXP, SEXP relMinAbundanceSEXP, SEXP absMinAbundanceSEXP, SEXP minRelCumIntensitySEXP, SEXP smoothWindowIMSSEXP, SEXP halfWindowIMSSEXP, SEXP maxGapIMSSEXP, SEXP topMostSEXP, SEXP minIntensityIMSSEXP, SEXP minIntensityPreSEXP, SEXP minIntensityPostSEXP, SEXP minBPIntensitySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSReadBackend& >::type backend(backendSEXP);
    ...
    Rcpp::traits::input_parameter< SpectrumRawTypes::PeakAbundance >::type relMinAbundance(relMinAbundanceSEXP);
    Rcpp::traits::input_parameter< SpectrumRawTypes::PeakAbundance >::type absMinAbundance(absMinAbundanceSEXP);
    Rcpp::traits::input_parameter< float >::type minRelCumIntensity(minRelCumIntensitySEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(getMSPeakLists(backend, startTimes, endTimes, precursorMZs, fixedIsolationWidth, withPrecursor, retainPrecursor, MSLevel, method, mzWindow, startMobs, endMobs, relMinAbundance, absMinAbundance, minRelCumIntensity, smoothWindowIMS, halfWindowIMS, maxGapIMS, topMost, minIntensityIMS, minIntensityPre, minIntensityPost, minBPIntensity));
    return rcpp_result_gen;
END_RCPP
}
// getEIMList
...
// collapseIMSFrames
Rcpp::List collapseIMSFrames(const MSReadBackend& backend, SpectrumRawTypes::Mass mzStart, SpectrumRawTypes::Mass mzEnd, SpectrumRawTypes::Mobility mobilityStart, SpectrumRawTypes::Mobility mobilityEnd, unsigned smoothWindow, unsigned halfWindow, SpectrumRawTypes::Mass maxGap, const std::string& method, SpectrumRawTypes::Mass mzWindow, SpectrumRawTypes::Intensity minIntensityIMS, bool includeMSMS);
RcppExport SEXP _patRoon_collapseIMSFrames(SEXP backendSEXP, SEXP mzStartSEXP, SEXP mzEndSEXP, SEXP mobilityStartSEXP, SEXP mobilityEndSEXP, SEXP smoothWindowSEXP, SEXP halfWindowSEXP, SEXP maxGapSEXP, SEXP methodSEXP, SEXP mzWindowSEXP, SEXP minIntensityIMSSEXP, SEXP includeMSMSSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSReadBackend& >::type backend(backendSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(collapseIMSFrames(backend, mzStart, mzEnd, mobilityStart, mobilityEnd, smoothWindow, halfWindow, maxGap, method, mzWindow, minIntensityIMS, includeMSMS));
    return rcpp_result_gen;
END_RCPP
}
// getIMSIsolationInfo
...
Rcpp::DataFrame testCentroidIMSFrame(const std::vector<SpectrumRawTypes::Mass>& mzs, const std::vector<SpectrumRawTypes::Intensity>& ints, SpectrumRawTypes::Mobility mobStart, SpectrumRawTypes::Mobility mobEnd, unsigned smoothWindow, unsigned halfWindow, SpectrumRawTypes::Mass maxGap);
RcppExport SEXP _patRoon_testCentroidIMSFrame(SEXP mzsSEXP, SEXP intsSEXP, SEXP mobStartSEXP, SEXP mobEndSEXP, SEXP smoothWindowSEXP, SEXP halfWindowSEXP, SEXP maxGapSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::vector<SpectrumRawTypes::Mass>& >::type mzs(mzsSEXP);
    ...
    Rcpp::traits::input_parameter< unsigned >::type halfWindow(halfWindowSEXP);
    Rcpp::traits::input_parameter< SpectrumRawTypes::Mass >::type maxGap(maxGapSEXP);
    rcpp_result_gen = Rcpp::wrap(testCentroidIMSFrame(mzs, ints, mobStart, mobEnd, smoothWindow, halfWindow, maxGap));
    return rcpp_result_gen;
END_RCPP
}
// loadEICIntensities
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_patRoon_getStats", (DL_FUNC) &_patRoon_getStats, 1},
    ...
    {"_patRoon_getCentroidedFrame", (DL_FUNC) &_patRoon_getCentroidedFrame, 7},
