...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< SpectrumRawTypes::Time >::type minAdjacentTime(minAdjacentTimeSEXP);
    Rcpp::traits::input_parameter< SpectrumRawTypes::Intensity >::type minAdjacentPointIntensity(minAdjacentPointIntensitySEXP);
    rcpp_result_gen = Rcpp::wrap(getEICList(backend, startMZs, endMZs, startTimes, endTimes, startMobs, endMobs, mzExpIMSWindow, minIntensityIMS, compress, showProgress, withBP, minEICIntensity, minAdjacentTime, minAdjacentPointIntensity));
    return rcpp_result_gen;
END_RCPP
}
// getMSMetadata
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(getMSPeakLists(backend, startTimes, endTimes, precursorMZs, withPrecursor, retainPrecursor, MSLevel, method, mzWindow, startMobs, endMobs, minAbundanceRel, minAbundanceAbs, minAbundanceIMSRel, minAbundanceIMSAbs, topMost, minIntensityIMS, minIntensityPre, minIntensityPost, minBPIntensity));
    return rcpp_result_gen;
END_RCPP
}
// getEIMList
...
RcppExport SEXP _patRoon_getEIMList(SEXP backendSEXP, SEXP startMZsSEXP, SEXP endMZsSEXP, SEXP startTimesSEXP, SEXP endTimesSEXP, SEXP startMobsSEXP, SEXP endMobsSEXP, SEXP methodSEXP, SEXP mobWindowSEXP, SEXP minIntensitySEXP, SEXP mzExpIMSWindowSEXP, SEXP compressSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MSReadBackend& >::type backend(backendSEXP);
    ...
    Rcpp::traits::input_parameter< SpectrumRawTypes::Mass >::type mzExpIMSWindow(mzExpIMSWindowSEXP);
    Rcpp::traits::input_parameter< bool >::type compress(compressSEXP);
    rcpp_result_gen = Rcpp::wrap(getEIMList(backend, startMZs, endMZs, startTimes, endTimes, startMobs, endMobs, method, mobWindow, minIntensity, mzExpIMSWindow, compress));
    return rcpp_result_gen;
END_RCPP
}
// getPeakIntensities
