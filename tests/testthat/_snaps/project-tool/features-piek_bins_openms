...
workPath <- "test_temp/test-np/features-piek_bins_openms"
setwd(workPath)
...
genEICParams <- getPiekGenEICParams(methodMZ = "bins", mzRange = c(80, 600), mzStep = 0.02)
fList <- findFeatures(anaInfo, "piek", genEICParams = genEICParams, peakParams = getDefPeakParams("chrom", "openms"))
