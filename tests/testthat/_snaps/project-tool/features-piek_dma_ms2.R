...
workPath <- "<WORK_PATH>/test-np/features-piek_dma_ms2"
setwd(workPath)
...
genEICParams <- getPiekEICParams(filter = "ms2", filterIMS = "none", mzRange = c(80, 800), mzStep = 0.02,
                                 mobRange = c(0.4, 1.3), mobStep = 0.08, rtWindow = 2, mzWindow = NULL, minTIC = 10000)
