...
genEICParams <- getPiekEICParams(filter = "ms2", filterIMS = "ms2", mzRange = c(80, 800), mzStep = 0.02,
                                 mobRange = c(0.4, 1.3), mobStep = 0.08, rtWindow = 2, mzWindow = NULL,
                                 mobWindow = 0.04, minTIC = 10000)
