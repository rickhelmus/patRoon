...
workPath <- "<WORK_PATH>/test-np/features-suspects_sets_eic_suspects"
setwd(workPath)
...
fGroups <- screenSuspects(fGroups, list(suspListPos, suspListNeg), onlyHits = TRUE)
