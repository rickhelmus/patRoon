...
workPath <- "<WORK_PATH>/test-np/pretreatment-steps"
setwd(workPath)
...
if (doDataPretreatment)
{
    ...
    convertMSFiles(anaInfo, typeFrom = "centroid", formatFrom = "mzML", typeTo = "centroid", formatTo = "mzXML",
                   algorithm = "openms", overwrite = FALSE)
    convertMSFiles(anaInfo, typeFrom = "raw", formatFrom = "bruker", typeTo = "profile", formatTo = "mzML",
                   algorithm = "bruker", overwrite = FALSE)
    convertMSFiles(anaInfo, typeFrom = "ims", formatFrom = "mzML", typeTo = "centroid", formatTo = "mzML",
                   algorithm = "imscollapse", overwrite = FALSE)
    convertMSFiles(anaInfo, typeFrom = "raw", formatFrom = "bruker_ims", typeTo = "profile", formatTo = "mzML",
                   algorithm = "timsconvert", overwrite = FALSE)
}
