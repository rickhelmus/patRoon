...
Finally, the `annotatedPeakList()` function is useful inspect annotation results for a formula or compound candidate:
...
- Filtering data: overview common filters, (fGroup) filtering order?

### Features

- Mainly fGroups of interest
...
`rGroups`                                  | `featureGroups`             | Only keep (feature of) these replicate groups
