...
The previous sections already highlighted some steps necessary when starting a new data processing workflow. In general, when starting a new project analyses have to be selected and pre-treated......
