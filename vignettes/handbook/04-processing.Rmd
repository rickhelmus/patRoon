...
plotVenn(compsMF, compsSIR, labels = c("MF", "SIR")) # manual labelling
```
...
> **_NOTE_** Again, `checkChromatograms()` may be slow when processing larger datasets. The [reporting functionalities](#report) provide a good alternative to quickly get an overviewing of all EIC data.
