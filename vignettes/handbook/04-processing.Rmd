...
fGroups$M120_R328_81 # as above
fGroups[[1, "M120_R328_81"]] # only first analysis

# obtains list with MS and MS/MS peak lists
mslists[["M120_R328_81"]] # group averaged data
mslists[["analysis-1", "M120_R328_81"]] # feature data

# get all formula candidates for a feature (group)
formulas[["M120_R328_81"]] # group averaged data
...
# formula annotation for for a formula candidate of feature group M120_R328_81
annotatedPeakList(compounds, precursor = "C6H9N2", groupName = "M120_R328_81",
                  MSPeakLists = mslists)
...
plotEIC(componCAM, index = 7, fGroups = fGroups) # EICs from a component
...
plotSpec(formulas, precursor = "C6H9N2", groupName = "M120_R328_81",
         MSPeakLists = mslists)
...
plotSpec(componCAM, index = 7) # component spectrum
```
...
plotChord(fGroups, average = FALSE) # overlap between analyses
# compare with custom made groups: surface and ground
plotChord(fGroups, average = TRUE,
          outer = c(repl1 = "grp1", repl2 = "grp1", repl3 = "grp2"))

# compare MetFrag and SIRIUS results
plotVenn(compsMF, compsSIR,
         labels = c("MF", "SIR")) # manual labeling
```
