...
By default the `library` and `logic` algorithms use data that is installed with `patRoon` (based on X and @Scholle2015, respectively). However, it is also possible to use custom data.
