...
More sophisticates ways are of course to provide an upfront distinction between parent/TP feature groups. In the [third] example a workflow is demonstrated where fold changes are used.
...
In addition, several important filters are added to prioritize the data:
