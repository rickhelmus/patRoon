...
# only needed for RAMClustR integration
...
Note that the latter three commands concern installation of _optional_ packages. If you are unsure, you probably want to install RAMClustR but not any of the others.
