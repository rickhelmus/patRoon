...
Suspect screening     | `screenSuspects()` + `groupFeaturesScreening()`   | `featureGroups` 
...
if (knitr::is_html_output()) {
    knitr::include_graphics(knitr::image_uri(file.path(vignDir, "newp.png")))
} else
