...
fGroups <- groupFeaturesGreedy(fList, IMSWindow = 1)

# customize all tolerances and weights
fGroups <- groupFeaturesGreedy(fList,
                               rtWindow = 5,
                               mzWindow = 0.003,
                               IMSWindow = 0.5,
...
A few additional averaging parameters (assigned to the `avgFeatParams` and `avgFGroupParams` arguments) are available in IMS workflows. These are discussed in the reference manual (`?getDefAvgPListParams`).
