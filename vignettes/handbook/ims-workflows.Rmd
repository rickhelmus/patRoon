...
`TRUE`. The `filterIMS` EIC parameter can be set to filter EIC bins by mobility data, similarly as the `filter`
parameter is used to filter the bins by _m/z_. The following combinations of `filter` and `filterIMS` are supported:
