...
# formula annotations for the first formula candidate of feature group M120_R268_30
annotatedPeakList(formulas, index = 1, groupName = "M120_R268_30",
                  MSPeakLists = mslists)

# compound annotation for first candidate of feature group M120_R268_30
...
The `plotSpectrum` function is also able to visually compare (annotated) spectra. This works for `MSPeakLists`, `formulas` and `compounds` object data.
...
plotSpectrum(compounds, groupName = c("M120_R268_30", "M146_R309_68"), index = c(1, 1),
             MSPeakLists = mslists, plotStruct = FALSE)
```
