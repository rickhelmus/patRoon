...
> **NOTE** The [newProject tool](#newProject) can also be used to easily generate a sets workflow. Simply select "both" for the _Ionization_ option.
...
`unset`      | Converts this object to a regular workflow object. | The `set` argument must be given to specify which of the set data is to be converted.
