...
genEICParams <- getPiekEICParams(methodMZ = "bins")
...
genEICParams <- getPiekEICParams(methodMZ = "bins", mzRange = c(50, 1000), mzStep = 0.01)
peakParams <- getDefPeakParams("chrom", "piek")
fList <- findFeatures(anaInfo, "piek", genEICParams = genEICParams, peakParams = peakParams)
...
genEICParams <- getPiekEICParams(methodMZ = "suspects")
...
genEICParams <- getPiekEICParams(methodMZ = "ms2", retRange = c(120, 600), minTIC = 1E5)
