...
Suspect screening     | `screenSuspects()`                                | `featureGroups` 
...
```{r suspmz,eval=FALSE}
suspects <- data.frame(name = c("1H-benzotriazole", "phenyl urea", "2-quinolol"),
...
suspects <- data.frame(name = c("1H-benzotriazole", "phenyl urea", "TBA"),
