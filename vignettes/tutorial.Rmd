...
fGroups <- filter(fGroups, absMinIntensity = 10000, relMinReplicateAbundance = 1,
                  maxReplicateRSD = 0.75, blankThreshold = 5, retentionRange = c(110, -1))
```
...
* The `maxReplicateRSD` argument specifies the maximum relative standard deviation (RSD) of feature intensities within a replicate group.
